...
from app.models.technique import ProVideo, UserVideo, Analysis # ✅ Added UserVideo, Analysis
...
def seed_data():
    ...
    pro_videos = [
        ProVideo(
            id="pv_1", player_name="Roger F.", shot_type="Forehand", handedness="Right", tags="Topspin, Whip",
            video_url="https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", 
            thumbnail_url="https://media.giphy.com/media/3o7TKrEzvJbsQNtF5u/giphy.gif"
        ),
        ProVideo(
            id="pv_2", player_name="Serena W.", shot_type="Serve", handedness="Right", tags="Power, Flat",
        ...
        ProVideo(
            id="pv_3", player_name="Rafa N.", shot_type="Backhand", handedness="Left", tags="Two-Handed, Spin",
            video_url="https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4",
            thumbnail_url="https://media.giphy.com/media/xT9IgMw9fupOgFb7yM/giphy.gif"
        )
    ]
    db.add_all(pro_videos)
    print("   ✅ Pro Videos added.")

    # --- USER UPLOADS (For 'My Videos' Tab) ---
    user_videos = [
        UserVideo(
            id="uv_1", user_id="user_rafa", title="My Practice Serve", 
            video_url="https://storage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4",
            shot_type="Serve"
        ),
        UserVideo(
            id="uv_2", user_id="user_rafa", title="Forehand Analysis", 
            video_url="https://storage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
            shot_type="Forehand"
        ),
        # Coach Upload
        UserVideo(
            id="uv_3", user_id="user_coach_1", title="Demo for Students", 
